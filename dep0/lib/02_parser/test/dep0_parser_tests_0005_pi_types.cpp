...
{
    BOOST_TEST_REQUIRE(pass("0005_pi_types/test_0179.depc"));
...
{
    BOOST_TEST_REQUIRE(pass("0005_pi_types/test_0180.depc"));
...
{
    BOOST_TEST_REQUIRE(pass("0005_pi_types/test_0182.depc"));
    BOOST_TEST_REQUIRE(pass_result->type_defs.size() == 1ul);
...
{
    BOOST_TEST_REQUIRE(pass("0005_pi_types/test_0184.depc"));
    BOOST_TEST_REQUIRE(pass_result->func_defs.size() == 1ul);
    auto const& f = pass_result->func_defs[0ul];
    BOOST_TEST(f.name == "f");
    BOOST_TEST_REQUIRE(f.value.args.size() == 3ul);
...
{
    BOOST_TEST_REQUIRE(pass("0005_pi_types/test_0185.depc"));
    BOOST_TEST_REQUIRE(pass_result->func_defs.size() == 1ul);
    auto const& f = pass_result->func_defs[0ul];
    BOOST_TEST(f.name == "f");
    BOOST_TEST_REQUIRE(f.value.args.size() == 2ul);
...
{
    BOOST_TEST_REQUIRE(pass("0005_pi_types/test_0186.depc"));
    BOOST_TEST_REQUIRE(pass_result->func_defs.size() == 1ul);
    auto const& f = pass_result->func_defs[0ul];
    BOOST_TEST(f.name == "f");
    BOOST_TEST_REQUIRE(f.value.args.size() == 2ul);
