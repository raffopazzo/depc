    ...
    boost::multiprecision::cpp_int const& b)
{
    switch (width)
    {
    case ast::width_t::_8: return cpp_int_sub_signed<8>(a, b);
    case ast::width_t::_16: return cpp_int_sub_signed<16>(a, b);
    case ast::width_t::_32: return cpp_int_sub_signed<32>(a, b);
    case ast::width_t::_64: return cpp_int_sub_signed<64>(a, b);
    ...
    boost::multiprecision::cpp_int const& b)
{
    switch (width)
    {
    case ast::width_t::_8: return cpp_int_sub_unsigned<8>(a, b);
    case ast::width_t::_16: return cpp_int_sub_unsigned<16>(a, b);
    case ast::width_t::_32: return cpp_int_sub_unsigned<32>(a, b);
    case ast::width_t::_64: return cpp_int_sub_unsigned<64>(a, b);
    default: __builtin_unreachable();
    }
}
...
cpp_int_sub(
    ...
    boost::multiprecision::cpp_int const& b)
{
    return sign == ast::sign_t::signed_v ? cpp_int_sub_signed(width, a, b) : cpp_int_sub_unsigned(width, a, b);
}
