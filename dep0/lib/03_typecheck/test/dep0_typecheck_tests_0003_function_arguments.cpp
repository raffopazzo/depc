...
BOOST_AUTO_TEST_CASE(test_0170) { BOOST_TEST(fail("0003_function_arguments/test_0170.depc")); }
BOOST_AUTO_TEST_CASE(test_0171) { BOOST_TEST(fail("0003_function_arguments/test_0171.depc")); }
