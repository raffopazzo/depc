...
BOOST_AUTO_TEST_CASE(pass_000)
{
    ...
    BOOST_TEST_REQUIRE(pass_result->entries.size() == 3ul);
    {
        ...
        BOOST_TEST(is_type(f->properties.sort.get(), pi_of(std::tuple{typename_("t")}, is_typename)));
    ...
    }
    {
        ...
        BOOST_TEST(is_type(f->properties.sort.get(), pi_of(std::tuple{typename_("t"), arg_of(var("t"), "x")}, var("t"))));
...
BOOST_AUTO_TEST_CASE(pass_003)
{
    ...
    }
    {
        ...
        BOOST_TEST(is_type(f->properties.sort.get(), pi_of(std::tuple{arg_of(is_bool, "which")}, is_typename)));
        BOOST_TEST_REQUIRE(f->value.args.size() == 1ul);
...
BOOST_AUTO_TEST_CASE(pass_004)
{
    ...
    }
    {
        ...
        BOOST_TEST(is_type(f->properties.sort.get(), pi_of(std::tuple{arg_of(is_i32)}, is_bool)));
        BOOST_TEST_REQUIRE(f->value.args.size() == 1ul);
    ...
    }
    {
        ...
        BOOST_TEST(is_type(f->properties.sort.get(), pi_of(std::tuple{arg_of(is_bool)}, is_i32)));
        BOOST_TEST_REQUIRE(f->value.args.size() == 1ul);
...
BOOST_AUTO_TEST_CASE(pass_006)
{
    ...
    BOOST_TEST_REQUIRE(pass_result->entries.size() == 3ul);
    {
        ...
        BOOST_TEST(is_type(f->properties.sort.get(), pi_of(std::tuple{arg_of(is_typename, "t")}, is_typename)));
        BOOST_TEST_REQUIRE(f->value.args.size() == 1ul);
    ...
    }
    {
        ...
        BOOST_TEST_REQUIRE(f);
        BOOST_TEST(f->name == "f");
        BOOST_TEST(is_type(f->properties.sort.get(), pi_of(std::tuple{}, app_of(global("type_id"), is_unit))));
        BOOST_TEST(f->value.args.size() == 0ul);
...
BOOST_AUTO_TEST_CASE(pass_008)
{
    ...
    BOOST_TEST_REQUIRE(pass_result->entries.size() == 3ul);
    {
        ...
        BOOST_TEST_REQUIRE(f);
        BOOST_TEST(f->name == "f");
        BOOST_TEST(is_type(f->properties.sort.get(), pi_of(std::tuple{}, is_typename)));
        BOOST_TEST(f->value.args.size() == 0ul);
        BOOST_TEST(is_typename(f->value.ret_type.get()));
        BOOST_TEST_REQUIRE(f->value.body.stmts.size() == 1ul);
    ...
    }
    {
        ...
        BOOST_TEST_REQUIRE(f);
        BOOST_TEST(f->name == "g");
        BOOST_TEST(is_type(f->properties.sort.get(), pi_of(std::tuple{arg_of(app_of(global("f")))}, is_typename)));
        BOOST_TEST_REQUIRE(f->value.args.size() == 1ul);
...
BOOST_AUTO_TEST_CASE(pass_010)
{
    ...
    }
    {
        ...
        BOOST_TEST(is_unit(f->value.ret_type.get()));
        BOOST_TEST_REQUIRE(f->value.body.stmts.size() == 1ul);
        BOOST_TEST(is_func_call_of(f->value.body.stmts[0ul], global("h"), global("f"), constant(0)));
    }
}
