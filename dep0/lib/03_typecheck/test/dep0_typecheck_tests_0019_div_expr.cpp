...
BOOST_AUTO_TEST_CASE(pass_003) { BOOST_TEST_REQUIRE(pass("0019_div_expr/pass_003.depc")); }
...
BOOST_AUTO_TEST_CASE(typecheck_error_003) { BOOST_TEST_REQUIRE(fail("0019_div_expr/typecheck_error_003.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_004) { BOOST_TEST_REQUIRE(fail("0019_div_expr/typecheck_error_004.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_005) { BOOST_TEST_REQUIRE(fail("0019_div_expr/typecheck_error_005.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_006) { BOOST_TEST_REQUIRE(fail("0019_div_expr/typecheck_error_006.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_007) { BOOST_TEST_REQUIRE(fail("0019_div_expr/typecheck_error_007.depc")); }
