 ...
 */
#define BOOST_TEST_MODULE dep0_typecheck_tests_0024_mutability
...
BOOST_FIXTURE_TEST_SUITE(dep0_typecheck_tests_0024_mutability, TypecheckTestsFixture)
...
BOOST_AUTO_TEST_CASE(pass_000)
{
    ...
    }
    {
        ...
        BOOST_TEST_REQUIRE(f->value.args.size() == 1ul);
        BOOST_TEST(is_arg(f->value.args[0], global("t"), "x", yes));
        BOOST_TEST(is_global(f->value.ret_type.get(), "t"));
...
BOOST_AUTO_TEST_CASE(pass_002) { BOOST_TEST(pass("0024_mutability/pass_002.depc")); }
    ...
    }
    {
        ...
        BOOST_TEST(
            is_immutable_block(
                ...
                {"x"},
                std::tuple{
                    return_of(app_of(global("f0"), scopeof("x"), addressof("x")))
                }));
    }
    {
        auto const f = std::get_if<dep0::typecheck::func_def_t>(&pass_result->entries[2]);
...
BOOST_AUTO_TEST_CASE(typecheck_error_000) { BOOST_TEST(fail("0024_mutability/typecheck_error_000.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_001) { BOOST_TEST(fail("0024_mutability/typecheck_error_001.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_002) { BOOST_TEST(fail("0024_mutability/typecheck_error_002.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_003) { BOOST_TEST(fail("0024_mutability/typecheck_error_003.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_004) { BOOST_TEST(fail("0024_mutability/typecheck_error_004.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_005) { BOOST_TEST(fail("0024_mutability/typecheck_error_005.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_006) { BOOST_TEST(fail("0024_mutability/typecheck_error_006.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_007) { BOOST_TEST(fail("0024_mutability/typecheck_error_007.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_008) { BOOST_TEST(fail("0024_mutability/typecheck_error_008.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_009) { BOOST_TEST(fail("0024_mutability/typecheck_error_009.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_010) { BOOST_TEST(fail("0024_mutability/typecheck_error_010.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_011) { BOOST_TEST(fail("0024_mutability/typecheck_error_011.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_012) { BOOST_TEST(fail("0024_mutability/typecheck_error_012.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_013) { BOOST_TEST(fail("0024_mutability/typecheck_error_013.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_014) { BOOST_TEST(fail("0024_mutability/typecheck_error_014.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_015) { BOOST_TEST(fail("0024_mutability/typecheck_error_015.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_016) { BOOST_TEST(fail("0024_mutability/typecheck_error_016.depc")); }
BOOST_AUTO_TEST_CASE(typecheck_error_017) { BOOST_TEST(fail("0024_mutability/typecheck_error_017.depc")); }
