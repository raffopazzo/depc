...
struct TypecheckTestsFixture
{
    ...
    {
        return dep0::testing::deref<dep0::typecheck::properties_t>(std::forward<Args>(args)...);
    }
    ...
    {
        return dep0::testing::ref_of<dep0::typecheck::properties_t>(std::forward<Args>(args)...);
    }

    template <typename... Args>
    static constexpr auto sigma_of(Args&&... args)
    {
        return dep0::testing::sigma_of<dep0::typecheck::properties_t>(std::forward<Args>(args)...);
    }
    ...
    template <typename... Args>
    static constexpr auto assign_of(Args&&... args)
    {
        return dep0::testing::assign_of<dep0::typecheck::properties_t>(std::forward<Args>(args)...);
    }
    ...
    {
        return dep0::testing::mult<dep0::typecheck::properties_t>(std::forward<Args>(args)...);
    }
